 ...
 */
public class CrawlConfig extends Config<CrawlItem> {
    ...
    @Override
    public CrawlItem createResultObject ( ContentApi.Entry entry ) throws ParseException {
        return new CrawlItem ( entry );
    }

    @Override
    public CrawlItem createResultObject ( Element current ) throws ParseException {
        return new CrawlItem ( current );
    }
